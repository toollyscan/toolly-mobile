...
# Browser-safe Gradle wrapper bootstrap. The reviewed wrapper JAR is stored as
# base64 because this repository is created through the GitHub contents API.
set -eu

APP_HOME=$(CDPATH= cd -- "$(dirname -- "$0")" && pwd)
BOOTSTRAP_DIR="$APP_HOME/.gradle-bootstrap"
WRAPPER_JAR="$BOOTSTRAP_DIR/gradle-wrapper.jar"
WRAPPER_SOURCE="$APP_HOME/gradle/wrapper/gradle-wrapper.jar.base64"
WRAPPER_PROPERTIES="$BOOTSTRAP_DIR/gradle-wrapper.properties"
