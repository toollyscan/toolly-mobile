...
Android platform image decoding receives app-private `File` objects at the UI boundary. Decoding
is off-main and bounded, and no persistent plaintext image cache is created. Page descriptions
